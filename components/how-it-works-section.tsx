    ...
    <div className="w-full border-b border-[rgba(55,50,47,0.12)]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {steps.map((step, index) => (
          <div
            key={index}
            className="flex flex-col gap-5 p-6 sm:p-8 md:p-10 border-b sm:border-b-0 sm:border-r border-[rgba(55,50,47,0.12)] last:border-r-0 relative"
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#EBF7FF] border border-[#5BB8F5]/30 flex items-center justify-center flex-shrink-0">
