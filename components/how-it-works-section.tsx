...
const steps = [
  ...
  {
    number: "02",
    title: "Все учителя получают AI-ассистента",
    description:
      "Каждый учитель — от информатики до математики — получает AI-копилота. Первое КМЖ генерируется за 2 минуты с автопривязкой к ГОСО 2026.",
    tag: "Alashed EDU",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    description:
      "Директор видит весь инвентарь в дашборде и заказывает в один клик через Alash Electronics — официальный импорт без посредников.",
    tag: "Alash Electronics",
  },
]
